          ...
          <SettingsCardBody>
                  ...
                  <div
                    ...
                    className={`rounded-lg border px-4 py-3 ${
                      notification.is_read
                        ...
                        : "border-[var(--color-accent-custom,#22C55E)]/30 bg-[var(--color-accent-custom,#22C55E)]/5"
                    }`}
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {!notification.is_read && (
                        <span className="text-[10px] font-semibold uppercase text-[var(--color-accent-custom,#22C55E)]">
                          New
                        </span>
                      )}
                    </div>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link
                ...
                className="text-sm text-[var(--color-accent-custom,#22C55E)] hover:underline"
              >
