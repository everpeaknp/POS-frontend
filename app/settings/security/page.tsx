                      ...
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {session.is_current && (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[var(--color-accent-custom,#22C55E)] bg-[var(--color-accent-custom,#22C55E)]/10 rounded-full">
                                <span className="w-1.5 h-1.5 rounded-full bg-[var(--color-accent-custom,#22C55E)]" />
                                Current
                              </span>
                            )}
                          </div>
