    ...
    >
      <SettingsCard className="max-w-lg mx-auto">
        <SettingsCardBody className="text-center py-10">
          {status === "success" && (
            <>
              <CheckCircle className="h-10 w-10 text-[#4A5D7A] mx-auto mb-4" />
              <h2 className="text-base font-semibold text-gray-900">Payment successful</h2>
              <p className="text-sm text-gray-500 mt-1">{message}</p>
              <Link
                href="/settings/billing"
                className="mt-6 inline-flex h-9 items-center justify-center rounded-lg bg-[#4A5D7A] px-4 text-sm font-medium text-white hover:bg-[#2E3E52]"
              >
                Back to billing
              </Link>
            </>
