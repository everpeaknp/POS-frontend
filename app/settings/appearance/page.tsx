...
import { Palette, Globe, Monitor, Sun, Moon, Laptop, ChevronDown, PanelLeft, PanelTop, Sparkles, RotateCcw, Check, Eye, Settings, ChevronRight, XCircle, Tags } from "lucide-react";
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive && "ring-2 ring-offset-2 ring-foreground scale-105 shadow-lg"
                      )}
                    ...
                    >
                      {isActive && (
                        <div className="absolute inset-0 flex items-center justify-center animate-in zoom-in-50 duration-200">
                          <div className="rounded-full bg-white/90 backdrop-blur-sm p-1 shadow-sm">
            ...
            <div id="advanced-customization" className="mt-4 space-y-4 animate-in fade-in-50 slide-in-from-top-2 duration-300" role="region" aria-label="Advanced customization options">
              <SettingsCard>
                <SettingsCardHeader
                  ...
                  description="Advanced display and accessibility options"
                />
                <SettingsCardBody className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {preferences.compact_mode ? "Compact" : "Default"}
                      </span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Adjust the base font size for better readability. Use compact mode for smaller text.
                    </p>
                  </div>
                  ...
                  <div className="pt-4 border-t space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {preferences.smooth_animations ? "Normal" : "Reduced"}
                      </span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Disable smooth animations in the Display section above to reduce motion.
                    </p>
                  </div>
                  ...
                  <div className="pt-4 border-t space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      High contrast mode is automatically detected from your system preferences.
                    </p>
                  </div>
              ...
              <div className="flex items-start gap-2 p-3 rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-900/50 dark:bg-amber-950/20">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                    Custom theme tokens, border radius, and spacing controls will be available in a future update for premium users.
                  </p>
                </div>
              </div>
            </div>
