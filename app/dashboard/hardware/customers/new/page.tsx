...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-gray-700 dark:text-foreground border-b border-gray-100 dark:border-border pb-2">{title}</h3>
      {children}
    </div>
  );
}
...
export default function NewHardwareCustomerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/hardware/customers/${response.data.id}`);
    } catch (error: any) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      <DashHeader title="Add Customer" subtitle="New hardware customer record" />
      <div className="flex-1 overflow-y-auto p-6">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-card rounded-xl border border-gray-100 dark:border-border shadow-sm p-6 lg:p-8 space-y-8 w-full min-h-full">
          ...
          <Section title="Basic Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <Field label="Customer Type">
                ...
                >
                  <SelectTrigger className="h-9 text-sm border-gray-200 dark:border-border"><SelectValue placeholder="Select customer type" /></SelectTrigger>
                  <SelectContent>
          ...
          <Section title="Billing Address">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              />
              <Label htmlFor="same" className="text-sm text-gray-600 dark:text-muted-foreground cursor-pointer">
          ...
          <Section title="Business Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
              ...
              <Field label="Payment Terms">
                ...
                >
                  <SelectTrigger className="h-9 text-sm border-gray-200 dark:border-border"><SelectValue placeholder="Select payment terms" /></SelectTrigger>
                  <SelectContent>
              ...
              <Field label="Customer Group">
                ...
                >
                  <SelectTrigger className="h-9 text-sm border-gray-200 dark:border-border"><SelectValue placeholder="Select customer group" /></SelectTrigger>
                  <SelectContent>
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-gray-100 dark:border-border">
            <Button 
              ...
              variant="ghost" 
              onClick={() => router.back()} 
              className="gap-1.5 text-gray-500 dark:text-muted-foreground"
              disabled={submitting}
            >
