        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className={selectedPeriod === "ytd" ? "bg-[#4A5D7A] hover:bg-[#4A5D7A]/90" : ""}
            >
            ...
            <Button
              ...
              className={selectedPeriod === "fy2026" ? "bg-[#4A5D7A] hover:bg-[#4A5D7A]/90" : ""}
            >
              {fy2026Label}
            </Button>
            <Button
              ...
              className={selectedPeriod === "fy2025" ? "bg-[#4A5D7A] hover:bg-[#4A5D7A]/90" : ""}
            >
              {fy2025Label}
            </Button>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <Button
              ...
              className="text-[#4A5D7A] hover:text-[#4A5D7A]/90"
            >
              {showBreakdown ? (
                <>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredIncome.map((entry) => (
                    <tr key={entry.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-right font-medium text-[#4A5D7A]">
                ...
                <tfoot className="bg-gray-50 border-t-2 border-gray-300">
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-right font-bold text-[#4A5D7A]">
