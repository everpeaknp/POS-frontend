  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-50">
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 p-3 bg-[var(--color-accent-custom,#22C55E)] text-white rounded-full shadow-lg hover:bg-[var(--color-accent-custom,#22C55E)]/90 transition-all z-50 no-print"
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex justify-end gap-2 border-t pt-4">
            ...
            <Button onClick={handleSaveEdit} className="bg-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom,#22C55E)]/90">
              Save Changes
            </Button>
          </div>
        </DialogContent>
