            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A5D7A] focus:border-transparent"
                  placeholder="100000"
                />
              </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#4A5D7A] text-white text-sm font-medium rounded-lg hover:bg-[#2E3E52] transition-colors"
            >
      ...
      <Dialog open={showAddLoanForm} onOpenChange={setShowAddLoanForm}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-gray-100">
            ...
            <Button type="button" onClick={handleAddLoan} className="bg-[#4A5D7A] hover:bg-[#2E3E52] text-white px-6">
              Save Loan
            </Button>
          </div>
        </DialogContent>
