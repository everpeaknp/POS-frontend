              ...
              <tbody className="divide-y divide-gray-50">
                {filtered.map((dn) => (
                    <tr key={dn.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-4 py-3 font-medium text-[var(--color-accent-custom,#22C55E)] cursor-pointer hover:underline" onClick={() => router.push(`/dashboard/purchase/debit-notes/${dn.id}`)}>{dn.debit_note_number}</td>
