      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 lg:p-8 space-y-8 w-full min-h-full">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-gray-100">
            ...
            <Button className="bg-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom-600,#16A34A)] text-white px-6" onClick={() => handleSubmit()} disabled={submitting}>
              Issue Debit Note
            </Button>
          </div>
        </div>
