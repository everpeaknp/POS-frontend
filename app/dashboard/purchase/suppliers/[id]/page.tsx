    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 p-6 space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm flex flex-wrap items-start gap-4">
          <div className="w-14 h-14 rounded-full bg-[var(--color-accent-custom,#22C55E)]/10 flex items-center justify-center text-2xl font-bold text-[var(--color-accent-custom,#22C55E)]">
            {supplier.name[0]}
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-50">
                {invoices.length > 0 ? invoices.map((inv) => (
                  ...
                  >
                    <td className="px-4 py-3 font-medium text-[var(--color-accent-custom,#22C55E)]">{inv.invoice_number}</td>
