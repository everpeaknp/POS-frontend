        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 lg:p-8 space-y-8 w-full min-h-full">
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-between">
            <div className="flex-1 min-w-0">
              ...
              <textarea className="w-full h-24 text-sm border border-gray-200 rounded-lg px-3 py-2 resize-none focus:outline-none focus:border-[#4A5D7A]" placeholder="Additional notes..." value={form.notes} onChange={(e) => setForm({ ...form, notes: e.target.value })} />
            </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-gray-100">
            ...
            <Button className="bg-[#4A5D7A] hover:bg-[#2E3E52] text-white px-6" onClick={() => handleSubmit("paid")} disabled={submitting}>
