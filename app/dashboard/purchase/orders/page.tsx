    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 p-6 space-y-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button size="sm" className="h-9 bg-[#4A5D7A] hover:bg-[#2E3E52] text-white gap-1.5" onClick={() => router.push("/dashboard/purchase/orders/new")}>
              ...
              <tbody className="divide-y divide-gray-50">
                {paginated.map((o) => (
                      <tr key={o.id} className="hover:bg-gray-50/50 transition-colors">
                        <td className="px-4 py-3 font-medium text-[#4A5D7A] cursor-pointer hover:underline" onClick={() => router.push(`/dashboard/purchase/orders/${o.id}`)}>{o.po_number}</td>
