              ...
              {(agingAR.customers ?? []).map((c) => (
                <tr key={c.customer_id} className="border-t border-gray-100">
                  <td className="px-3 py-2">
                    <Link href={`/dashboard/sales/customers/${c.customer_id}`} className="text-[var(--color-accent-custom,#22C55E)] hover:underline">
                      {c.customer_name}
                    </Link>
                  </td>
            ...
            <tbody>
              {(agingAP.suppliers ?? []).map((s) => (
                <tr key={s.supplier_id} className="border-t border-gray-100">
                  <td className="px-3 py-2">
                    <Link href={`/dashboard/purchase/suppliers/${s.supplier_id}`} className="text-[var(--color-accent-custom,#22C55E)] hover:underline">
                      {s.supplier_name}
                    </Link>
                  </td>
