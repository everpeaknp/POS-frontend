      ...
      <div className="flex flex-col min-h-full">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center">
            ...
            <Button onClick={fetchAccounts} className="bg-[#4A5D7A] hover:bg-[#2E3E52] text-white">
              Retry
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          {stats.byType.map(({ type, count, balance }) => (
            <button
              ...
              className={`text-left bg-card rounded-xl border border-border shadow-sm p-4 hover:border-[#4A5D7A]/40 transition-colors ${
                typeFilter === type ? "ring-2 ring-[#4A5D7A]/30 border-[#4A5D7A]/40" : ""
              }`}
            >
        ...
        {accounts.length === 0 ? (
          <div className="bg-card rounded-xl border border-border shadow-sm p-12 text-center">
            ...
            <Link href="/dashboard/accounting/chart-of-accounts/new">
              <Button className="bg-[#4A5D7A] hover:bg-[#2E3E52] text-white gap-1.5">
                <Plus className="h-4 w-4" /> Add Account
              </Button>
            </Link>
          </div>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center justify-end gap-0.5">
                              <Link
                                ...
                                title="View ledger"
                              >
                                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-muted-foreground hover:text-[#4A5D7A]">
