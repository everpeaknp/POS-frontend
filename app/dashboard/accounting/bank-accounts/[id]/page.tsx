        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-[var(--color-accent-custom,#22C55E)]/10 flex items-center justify-center">
                <CreditCard className="h-6 w-6 text-[var(--color-accent-custom,#22C55E)]" />
              </div>
              <div>
