...
export default function ConstructionReportsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Construction Reports</h1>
        <p className="mt-1 text-sm text-gray-600">
          Generate detailed budget and cost reports for construction sites
        </p>
      </div>

      {/* Site Selection */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Generate Site Report</h2>
        <div className="flex gap-4">
          ...
          <div className="flex items-end">
            <button
              ...
              className="px-6 py-2 bg-[#22C55E] text-white rounded-md hover:bg-[#16A34A] disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className={`px-4 py-2 rounded-lg font-medium ${getBudgetHealthColor(report.budget_health)}`}>
