...
export default function ConstructionReportsPage() {
  ...
  const getBudgetHealthColor = (health: string) => {
    const colors: Record<string, string> = {
      green: 'text-white bg-[var(--color-accent-custom,#22C55E)]',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 items-end">
          <div className="sm:col-span-2 lg:col-span-3 xl:col-span-4">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-border rounded-md bg-white dark:bg-card focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-custom,#22C55E)]"
            >
          ...
          <div className={`${constructionCardClass} p-6 lg:p-8`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <span className="inline-block px-2 py-1 text-xs font-medium rounded bg-[var(--color-accent-custom,#22C55E)] text-white">
          ...
          <div className={`${constructionCardClass} p-6 lg:p-8`}>
                ...
                <div
                  ...
                  className={`h-full transition-all duration-500 ${
                    report.budget_percentage < 80
                      ? 'bg-[var(--color-accent-custom,#22C55E)]'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p
                  className={`text-2xl font-bold ${report.remaining_budget >= 0 ? 'text-[var(--color-accent-custom,#22C55E)]' : 'text-red-600'}`}
                >
