          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Section title="Reason">
              <Field label="Reason for Credit Note" required>
                <textarea
                  className="w-full text-sm border border-gray-200 dark:border-border rounded-lg p-3 resize-none bg-white dark:bg-card focus:outline-none focus:ring-2 focus:ring-[#4A5D7A] focus:border-transparent"
                  rows={4}
