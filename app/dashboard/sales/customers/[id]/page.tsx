          ...
          <div className="p-6">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-full bg-[var(--color-accent-custom,#22C55E)]/10 flex items-center justify-center">
                  <span className="text-2xl font-bold text-[var(--color-accent-custom,#22C55E)]">{getInitials(customer.name)}</span>
                </div>
                <div>
              ...
              <Link href={`/dashboard/sales/customers/${customer.id}/edit`}>
                <Button size="sm" className="bg-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom-600,#16A34A)] text-white gap-2">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-border">
                  {invoices.map((inv: any) => (
                    <tr key={inv.id} className="hover:bg-gray-50/50 dark:hover:bg-muted/30">
                      <td className="px-4 py-3 font-mono text-xs text-[var(--color-accent-custom,#22C55E)]">
