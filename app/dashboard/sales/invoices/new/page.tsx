      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 lg:p-8 space-y-8 w-full min-h-full">
            ...
            <Field label="Customer" required>
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="h-9 px-3 border-[var(--color-accent-custom,#22C55E)] text-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom-50,#f0fdf4)] shrink-0"
          ...
          <div>
            ...
            <textarea 
              className="mt-1.5 w-full h-20 text-sm border border-gray-200 rounded-lg px-3 py-2 resize-none focus:outline-none focus:border-[var(--color-accent-custom,#22C55E)]"
