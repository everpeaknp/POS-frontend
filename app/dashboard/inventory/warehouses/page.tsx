      ...
      <div className="flex-1 p-6 space-y-4">
        <div className="flex gap-3 items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" className="h-9 bg-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom-600,#16A34A)] text-white gap-1.5" onClick={handleOpenCreate}>
