          ...
          <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1 w-full px-3 py-2 border border-gray-200 rounded-lg text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-custom,#22C55E)]"
                rows={4}
                disabled={loading}
              />
            </div>
