  ...
  const avatarButton = (
    <button
      ...
      className={cn(
        ...
        !disabled && "cursor-pointer transition-colors hover:border-[#4A5D7A]/50"
      )}
    ...
    >
      {displayUrl ? (
        ...
        <span className="flex h-full w-full items-center justify-center bg-[#4A5D7A]/10 text-lg font-semibold text-[#2E3E52]">
  ...
  const compactActions = !disabled && (
    <div className="flex flex-col items-center gap-1.5">
      <button
        type="button"
        onClick={openFilePicker}
        className="text-xs font-medium text-[#4A5D7A] hover:underline"
      >
