        ...
        >
          ...
          {insight.action_link && (
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-[var(--color-accent-custom,#22C55E)] text-white font-medium hover:bg-[var(--color-accent-custom,#22C55E)]/90 transition"
            >
