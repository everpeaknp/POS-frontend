  ...
  return (
    <footer className="desktop-statusbar h-7 shrink-0 flex items-center gap-3 px-3 text-[11px] bg-[#0f1a24] text-white/75 border-t border-white/10 select-none">
      ...
      <span className="inline-flex items-center gap-1" title="Internet / API network">
        {online && apiOk !== false ? (
          <Wifi className="h-3 w-3 text-[var(--color-accent-custom,#22C55E)]" />
        ) : (
      ...
      <span className="inline-flex items-center gap-1" title="API">
        <Server
          className={`h-3 w-3 ${apiOk === false ? "text-red-400" : "text-[var(--color-accent-custom,#22C55E)]"}`}
        />
      ...
      >
        <RefreshCw
          className={`h-3 w-3 ${syncing ? "animate-spin text-[var(--color-accent-custom,#22C55E)]" : pending ? "text-amber-400" : "text-[var(--color-accent-custom,#22C55E)]"}`}
        />
      ...
      >
        <Activity className="h-3 w-3 text-[var(--color-accent-custom,#22C55E)]" />
