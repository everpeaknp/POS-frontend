    ...
    >
      ...
      >
        <header className="h-12 shrink-0 flex items-center gap-2 px-4 border-b border-white/10">
          <Sparkles className="h-4 w-4 text-[var(--color-accent-custom,#22C55E)]" />
          ...
          {rows.map((row, i) => (
            <div
              ...
              className={`text-sm leading-relaxed whitespace-pre-wrap rounded-xl px-3 py-2.5 ${
                row.role === "user"
                  ? "bg-[var(--color-accent-custom,#22C55E)]/20 ml-8"
        ...
        <div className="p-3 border-t border-white/10 space-y-2">
          <div className="flex gap-2">
            <textarea
              ...
              className="flex-1 resize-none rounded-xl bg-white/5 border border-white/10 px-3 py-2 text-sm outline-none focus:border-[var(--color-accent-custom,#22C55E)]/50 placeholder:text-white/35"
              onKeyDown={(e) => {
            ...
            <button
              ...
              onClick={() => void submit()}
              className="h-auto px-3 rounded-xl bg-gradient-to-b from-[#16A34A] to-[var(--color-accent-custom,#22C55E)] disabled:opacity-40"
              aria-label="Send"
            >
