...
const statusStyles = {
  completed: "bg-slate-100 text-slate-700 dark:bg-slate-500/15 dark:text-slate-400",
...
const paymentStyles = {
  ...
  esewa: "bg-slate-100 text-slate-700 dark:bg-slate-500/15 dark:text-slate-400",
