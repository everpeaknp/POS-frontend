...
export function PosSessionsPageContent({
  ...
  const [newDialogOpen, setNewDialogOpen] = useState(openNewOnMount);
  ...
  const handleDialogOpenChange = (open: boolean) => {
    ...
    if (!open && openNewOnMount) {
      router.replace("/dashboard/pos/sessions", { scroll: false });
    }
  };
