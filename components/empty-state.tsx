...
export function EmptyState({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center py-28 gap-5">
      <div className="w-24 h-24 rounded-2xl bg-[var(--color-accent-custom,#22C55E)]/10 border border-[var(--color-accent-custom,#22C55E)]/20 flex items-center justify-center">
        <Icon className="h-12 w-12 text-[var(--color-accent-custom,#22C55E)]" />
      </div>
