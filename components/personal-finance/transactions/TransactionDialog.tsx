      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
              ...
              {categoryComboOpen && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-50">
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2 border-t border-gray-200 text-left text-sm text-[var(--color-accent-custom,#22C55E)] hover:bg-emerald-50 flex items-center gap-2"
                  >
          ...
          <div>
            ...
            <div className="mt-1">
              {!receiptFile ? (
                <label className="flex items-center justify-center w-full px-4 py-6 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[var(--color-accent-custom,#22C55E)] hover:bg-emerald-50 transition">
        ...
        <div className="flex justify-end gap-2 border-t pt-4">
          ...
          <Button onClick={onSave} className="bg-[var(--color-accent-custom,#22C55E)] hover:bg-[var(--color-accent-custom,#22C55E)]/90">
