      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-[var(--color-accent-custom,#22C55E)]">{formatCurrency(income)}</p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className={`text-2xl font-bold ${net >= 0 ? "text-[var(--color-accent-custom,#22C55E)]" : "text-red-600"}`}>
              {formatCurrency(net)}
            </p>
          </div>
        </div>
