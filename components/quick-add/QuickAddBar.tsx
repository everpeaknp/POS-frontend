        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          <div className="space-y-4 py-4">
              ...
              <div className="bg-white border-2 border-[#1e3a8a] rounded-lg p-4 space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-medium ${parsedData.type === 'income' ? 'text-[var(--color-accent-custom,#22C55E)]' : 'text-red-600'}`}>
            ...
            {!isPersonal && retailParsedCommand && (
              <div className="bg-white border-2 border-[var(--color-accent-custom,#22C55E)] rounded-lg p-4 space-y-3">
