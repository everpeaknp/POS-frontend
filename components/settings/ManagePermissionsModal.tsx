...
function ModulePermissionCard({
  ...
  return (
    <div className="shrink-0 rounded-2xl border border-gray-100 dark:border-border bg-white dark:bg-card overflow-hidden shadow-sm">
      ...
      >
        <div className="w-10 h-10 rounded-xl bg-[#4A5D7A]/10 flex items-center justify-center shrink-0">
          {Icon ? (
            <Icon className="h-5 w-5 text-[#4A5D7A]" />
          ) : (
            <Shield className="h-5 w-5 text-[#4A5D7A]" />
          )}
        </div>
          ...
          <div className="flex items-center justify-between gap-2 pt-3 pb-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-xs font-medium text-[#2E3E52] hover:underline"
              >
                Allow all
              </button>
        ...
        <div className="flex h-full min-h-0 flex-col">
          <DialogHeader className="shrink-0 space-y-0 border-b border-gray-100 px-5 pb-4 pt-5 text-left dark:border-border sm:px-6">
            <div className="flex items-start gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#4A5D7A]/10">
                <Shield className="h-5 w-5 text-[#4A5D7A]" />
              </div>
            ...
            <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-xl border border-gray-200 bg-white pl-10 pr-4 text-sm focus:border-[#4A5D7A] focus:outline-none focus:ring-2 focus:ring-[#4A5D7A]/20 dark:border-border dark:bg-card"
                />
              </div>
          ...
          <DialogFooter className="mx-0 mb-0 shrink-0 gap-3 rounded-none border-t border-gray-100 bg-white px-5 py-4 dark:border-border dark:bg-card sm:justify-between sm:px-6">
            ...
            <div className="flex w-full items-center gap-2 sm:w-auto">
              ...
              <Button
                ...
                onClick={onSave}
                disabled={saving}
                className="flex-1 bg-[#4A5D7A] text-white hover:bg-[#2E3E52] sm:flex-none"
              >
