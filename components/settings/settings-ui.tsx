...
export const settingsInputClass =
  "w-full h-10 px-3 rounded-lg border border-border bg-card text-sm text-foreground placeholder:text-muted-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-custom,#22C55E)]/20 focus:border-[var(--color-accent-custom,#22C55E)] disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed";
        ...
        {Icon && (
          <div
            className={cn(
              ...
              variant === "danger" ? "bg-red-100 dark:bg-red-900/40" : "bg-[var(--color-accent-custom,#22C55E)]/10"
            )}
          >
            <Icon className={cn("h-4 w-4", variant === "danger" ? "text-red-600 dark:text-red-400" : "text-[var(--color-accent-custom,#22C55E)]")} />
          </div>
        )}
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer shrink-0">
      <input
        ...
        disabled={disabled}
      />
      <div className="w-9 h-5 bg-muted peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-border after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[var(--color-accent-custom,#22C55E)] peer-disabled:opacity-50 peer-disabled:cursor-not-allowed" />
    </label>
  );
}
