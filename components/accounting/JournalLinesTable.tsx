...
export function JournalLinesTable({ lines, onChange, readOnly, accounts = [] }: Props) {
  ...
  return (
    <div className="space-y-2">
      ...
      {!readOnly && (
        <button onClick={addLine} className="flex items-center gap-1.5 text-sm text-[var(--color-accent-custom,#22C55E)] hover:text-[var(--color-accent-custom-600,#16A34A)] font-medium transition-colors">
